  ...
  return (
    <div className="fixed top-0 left-0 right-0 shadow-sm   rounded-xl  z-10 block md:flex sm:w-4/5 w-11/12 mx-auto mt-5 justify-between items-center">
        ...
        <div className=" relative">
          ...
          {showinfo && (
            <div
              className={`${
                isMounted ? "slide-in5" : ""
              } opacity-0 shadow-lg absolute top-[40px] left-7 w-80 bg-[#ffffffeb] border-b-4 border border-t-transparent px-3 text-justify z-10`}
            >
      ...
      <ul
        ...
        }transparentwhite shadow-lg  px-5 relative md:gap-12 text-center md:w-2/3 rounded-xl md:bg-white md:bg-opacity-80 md:items-end md:justify-around py-2`}
      >
        <li
          className={
